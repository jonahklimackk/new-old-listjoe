...
</div><div class="par"><h4>Privacy Policy Updates</h4>
...
</div><div class="par"><h4>Data Security</h4>
Data security is of the utmost importance to us and we are committed to ensuring the information we collect from you is secure. In order to prevent unauthorized access or disclosure, we have put in place procedures to safeguard and secure the information we collect online and offline.
</div><div class="par"><h4>What personal data we collect and why we collect it</h4>
</div><div class="par"><h4>Comments</h4>
When visitors leave comments on the site we collect the data shown in the comments form, and also the visitor’s IP address and browser user agent string to help spam detection.

An anonymized string created from your email address (also called a hash) may be provided to the Gravatar service to see if you are using it. The Gravatar service privacy policy is available here: https://automattic.com/privacy/. After approval of your comment, your profile picture is visible to the public in the context of your comment.
</div><div class="par"><h4>Media</h4>
If you upload images to the website, you should avoid uploading images with embedded location data (EXIF GPS) included. Visitors to the website can download and extract any location data from images on the website.
</div><div class="par"><h4>Contact forms</h4>
When visitors submit comments via the contact forms on the site we collect the data shown in the form in order to respond to your request, and also to help spam detection.
</div><div class="par"><h4>Cookies</h4>
A cookie is a small text file that is stored on your computer or other devices when you visit a website. They are very widely used in order to make websites function properly, or more efficiently, as well as provide information to the owners of the site.
...
Users may opt out of Google's use of cookies by visiting the <a href="https://adssettings.google.com/authenticated">Google Advertising Settings Page</a>
...
</div><div class="par"><h4>Analytics</h4>
Information that you provide to us when completing a form on our website, filling out a questionnaire, placing an order, subscribing to email or mailing lists, participating in surveys, and when contacting us both on and offline including:
<ul>
    <li>Name, contact information (such as phone and email), address.</li>
    <li>Information automatically received by us when you use the website, access our marketing information, or contact us by email or phone. We also use software tools such as Google Analytics to measure and collect session information, length of visits to certain pages, and help us understand how visitors use our website. This information may include IP addresses, browser type and version, operating system, device, and service provider, and more.If you wish not to have send information about your website visit to Google Analytics, download and install the <a href="https://tools.google.com/dlpage/gaoptout/">Google Analytics Opt-Out Browser Add-On</a> for your current web browser. The Google Analytics Opt-out Browser Add-on does not prevent information from being sent to our website or to other web analytics services.</li>
</ul>
</div><div class="par"><h4>Embedded content from other websites</h4>
Articles on this site may include embedded content (e.g. videos, audio, images, articles, etc.). Embedded content from other websites behaves in the exact same way as if the visitor has visited the other website.

These websites may collect data about you, use cookies, embed additional third-party tracking, and monitor your interaction with that embedded content, including tracing your interaction with the embedded content if you have an account and are logged in to that website.
</div><div class="par"><h4>Who we share your data with</h4>
By using our website, you imply consent to the use of cookies. However, if you do not consent to the use of cookies, please ensure that your browser or computer/device is set to reject or prompt before accepting third party cookies. This may prevent you from taking full advantage of the website.
</div><div class="par"><h4>Who Else May See Your Data</h4>
...
</div><div class="par"><h4>Controlling Your Personal Information</h4>
...
You may choose to restrict the collection or use of your personal information, and/or update and request details of any personal information which we hold about you, by contacting us via our website or at support [at] hacktheentrepreneur [dot] com.
</div><div class="par"><h4>Third Party Service Providers</h4>
...
</div><div class="par"><h4>Third Party Websites</h4>
Our website may contain links to the sites and services of partners, suppliers, advertisers, sponsors, licensors, and other third parties. We do not control the content or links that appear on these sites and are not responsible for the practices employed by sites linked to or from our website.

In addition, these sites or services, including their content and links, may be constantly changing. These sites and services may have their own privacy and other policies. Browsing and interaction on any other website, including websites linked to our website, is subject to that website’s own terms and policies. We cannot be responsible for the protection and privacy of any information which you provide while visiting third-party sites, and such sites are not governed by this privacy policy.
</div><div class="par"><h4>How long we retain your data</h4>
If you leave a comment, the comment and its metadata are retained indefinitely. This is so we can recognize and approve any follow-up comments automatically instead of holding them in a moderation queue.

For users that register on our website (if any), we also store the personal information they provide in their user profile. All users can see, edit, or delete their personal information at any time (except they cannot change their username). Website administrators can also see and edit that information.
</div><div class="par"><h4>What rights you have over your data</h4>
If you have an account on this site or have left comments, you can request to receive an exported file of the personal data we hold about you, including any data you have provided to us. You can also request that we erase any personal data we hold about you. This does not include any data we are obliged to keep for administrative, legal, or security purposes.
</div><div class="par"><h4>Applicable Law and Choice of Forum</h4>
This privacy policy is governed by the laws of the Province of Ontario, Canada. All matters arising out of these terms shall be resolved exclusively by the provincial and federal courts located in Toronto, Ontario. For this purpose, each party consents to personal jurisdiction in such provincial or federal court and waives any right to dismiss or transfer such action or proceeding because of the inconvenience of the forum. Nothing in this section shall prevent enforcement in another forum of any judgment obtained in a court identified in this paragraph.
</div><div class="par"><h4>Your Acceptance of These Terms</h4>
...
<em>This document was last updated on May 24, 2018</em>
</div>
</div>            </div>
