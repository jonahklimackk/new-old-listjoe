    ...
    <div class="cont">
      <div class="line" style="margin-bottom: 6px;">
        <div class="name input">Your Previous Ads</div>
        <div class="value">
      ...
      <div class="fs13">
        ...
        It must be [FI`RST_NAME] exactly or it will not work!
      </div>
      <br/>
      ...
      <script>
        ...
        .catch( error => {
          console.error( error );
                    ...
                    -->
{{--
    <textarea name="message" style="height: 161px;width: 562px;" id="message" name="message">{{ $soloMailing->message }}</textarea> --}}
